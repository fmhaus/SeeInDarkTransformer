...
class ImageSource:
    def __init__(self, path, prefix_length):
        ...
        self.files = {f[:prefix_length]:f for f in os.listdir(path) if f.lower().endswith('.png')}
        self.key_list = None
...
class ImageCompareApp:
    ...
    def on_resize(self, _event):
        # recreated canvas 100ms after resize is ended to prevent repeated canvas creations
