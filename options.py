class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--resume_epoch', type=int, default=1, help='epoch to resume training from (0 = train from zero)')
        ...
        parser.add_argument('--freeze_encoder', type=bool, default=True, help='If the encoder should be frozen')
        ...
        parser.add_argument('--dataset_folder', type=str, default='E:/workspace/Bach/Bach300/Learning-to-See-in-the-Dark/dataset', help='location of the downloaded and unzipped dataset')
        parser.add_argument('--preprocess_folder', type=str, default='E:/workspace/Bach/Bach300/SID2/v1/preprocessed_gts', help='location where preprocesses images are stored')
        parser.add_argument('--out_path', type=str, default='E:/workspace/Bach/Bach300/SID2/v1/checkpoints', help='location where logs and checkpoints are stored')
